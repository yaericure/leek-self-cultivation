...
function PartGroup({ part, onNavigate }) {
  ...
  return (
    <div className="mt-4">
      ...
      {open && (
        <div className="mt-1 space-y-0.5 border-l border-violet-300/60 pl-2 dark:border-violet-800/50">
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `block rounded-lg px-2.5 py-1.5 text-[13.5px] leading-snug transition-colors ${
          isActive
            ? "bg-violet-500/15 font-semibold text-violet-800 dark:bg-violet-400/15 dark:text-violet-300"
